    ...
    <main class="main">
        ...
        <div class="container">
            <section class="quiz-section">
                <div class="quiz-box">
                    <h1> History & Culture Quiz </h1>
                    <div class="quiz-header">
                        <span>The Knowledge Arena</span>
                        <span class="header-score">Score: 0 / 10</span>
                    </div>

                    <h2 class="question-text">What is the name of the highest mountain in Kenya?</h2>
            ...
            <section class="home">
                <div class="home-content">
                    <h1> The Knowledge Arena History & Culture Quiz </h1>
                    <p>Dive into the past with questions about historical events, famous figures, and cultural traditions. Explore different time periods, civilizations, and influential moments.</p>
