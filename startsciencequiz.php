        ...
        <div class="container">
            <section class="quiz-section">
                <div class="quiz-box">
                    ...
                    <h2 class="question-text">What does DNA stand for?</h2>
            ...
            <section class="home">
                <div class="home-content">
                    <h1> The Knowledge Arena Science and Nature Quiz </h1>
                    <p>Questions in this category focus on scientific concepts, natural phenomena, and the world around us. Expect topics related to biology, chemistry, astronomy, and more.</p>
