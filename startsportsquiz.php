...
<body>
        ...
        <div class="container">
            <section class="quiz-section">
                <div class="quiz-box">
                    ...
                    <h2 class="question-text">Who is the first Kenyan athlete to win an Olympic gold medal in a field event?</h2>
            ...
            <section class="home">
                <div class="home-content">
                    <h1> The Knowledge Arena Sports Quiz </h1>
                    <p>Test your sports knowledge with questions about athletes, teams, and various recreational activities.</p>
    ...
    <script src="sportsquestions.js"></script>
